                ...
                <div id="page-header" class="secondary-background">
                    <div class="container">
                        <div class="row no-margin">
                            <div class="text">
                                <h1 class="white">Relatórios, contas e atas.</h1>
                                <ul class="breadcrumb white">
                                    <li><a href="#">Home</a></li>
                                    <li>Relatórios, contas e atas</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div id="home-wrap" class="content-section fullpage-wrap">
                    <div class="container">
                        ...
                        <div class="row no-margin padding-lg">
                            <div class="col-md-4 padding-leftright-null">
                               <div class="text padding-topbottom-null">
                                   <h2 class="margin-bottom-null left">Relatórios e contas.</h2>
                               </div>
                            </div>
                            <div class="col-md-8 padding-leftright-null padding-md-top">
                                <div class="text padding-topbottom-null">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                                <div class="panel-body">
                                                    ...
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2015%' AND tipo LIKE '%relatorio%' ORDER BY data DESC");
                                                    ...
                                                    ?>
                                                        ...
                                                        <h4><a target="_blank" href="atas/atas-pdf/<?php echo $row['ficheiro']; ?>"><?php echo $row['titulo']; ?></a></h4>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2016%' AND tipo LIKE '%relatorio%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2017%' AND tipo LIKE '%relatorio%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2018%' AND tipo LIKE '%relatorio%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2019%' AND tipo LIKE '%relatorio%' ORDER BY data DESC");
                        ...
                        <div class="row no-margin padding-lg">
                            <div class="col-md-4 padding-leftright-null">
                               <div class="text padding-topbottom-null">
                                   <h2 class="margin-bottom-null left">Atas.</h2>
                               </div>
                            </div>
                            <div class="col-md-8 padding-leftright-null padding-md-top">
                                <div class="text padding-topbottom-null">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2015%' AND tipo LIKE '%ata%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2016%' AND tipo LIKE '%ata%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2017%' AND tipo LIKE '%ata%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2018%' AND tipo LIKE '%ata%' ORDER BY data DESC");
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                                <div class="panel-body">
                                                    ...
                                                    // Get records from the database
                                                    $query = $db->query("SELECT * FROM atas WHERE data LIKE '%2019%' AND tipo LIKE '%ata%' ORDER BY data DESC");
