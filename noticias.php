...
<html lang="en">
    ...
    <body>
        <script src="assets/js/show-hide-text.js"></script>
                ...
                <div id="home-wrap" class="content-section fullpage-wrap">
                    <div class="container">
                        ...
                        <section id="news" class="page">
                            <div class="news-items equal three-columns">
                                ...
                                <?php
                                  ...
                                  include 'dbConfig.php';
                                   ...
                                   $query = $db->query("SELECT * FROM noticias ORDER BY data DESC");
                            ...
                            <!--<div class="news-items equal three-columns postList"></div>
                        ...
                        <!--<section id="nav" class="padding-top-null">
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="nav-left">
                                        <a href="single-blog-style-2.html" class="btn-alt small shadow margin-null"><i class="icon ion-ios-arrow-left"></i><span>Mais antigo</span></a>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="nav-right">
                                        <a href="#" class="btn-alt small shadow margin-null"><span>Mais recente</span><i class="icon ion-ios-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>-->
