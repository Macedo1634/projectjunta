...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-2  filter-div">
      ...
      <a href="add-noticia.php" id="new-project-button"><i class="fa fa-plus"></i> Adicionar Noticia</a>
      
    </div>

    <div class="col-lg-10">
      <h1 class="my-4">Admin Notícias</h1>
      <hr/>
      <?php if ($noticias) : ?>
      <?php foreach ($noticias as $noticia) : ?>
          <div class="col-lg-4 col-md-6 col-xs-12 mb-4 target materials-card column">
              <div class="card h-100">
                  <a href="#"><img class="card-img-top" src="noticias-img/<?php echo $noticia['imagem']; ?>" alt=""></a>
                    <div class="card-body">
                        <p class="card-title">
                          <?php echo $noticia['titulo']; ?>
                        </p>
                        <p class="cat"><?php echo $noticia['texto']; ?></p>
                        <p class="cat"><?php echo $noticia['data']; ?></p>

                        <div class="row">
                        
                        <div class="col-lg-4 material-btn" style="">
                            <a href="#" data-target="#delete-modal" data-toggle="modal" data-material="<?php echo $noticia['id']; ?>"><i class="fa fa-trash icons"></i></a>
                            <a href="edit-noticia.php?id=<?php echo $noticia['id']; ?>"><i class="fa fa-edit icons"></i></a>
                        </div>
                        </div>
...
$('#delete-modal').on('shown.bs.modal', function (event) {
  ...
  var modal = $(this);
  modal.find('.modal-title').text('Apagar notícia #' + id);
  modal.find('#confirm').attr('href', 'delete-noticia.php?id=' + id);
});
</script>
</body>
</html>